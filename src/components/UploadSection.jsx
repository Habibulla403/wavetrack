...
export default function UploadSection({ onSongAdded }) {
  ...
  if (done) return (
    <div className="rounded-2xl border border-emerald-500/25 bg-emerald-500/10 p-8 flex flex-col items-center text-center gap-3">
      ...
      <p className="text-emerald-300 font-semibold">Song uploaded!</p>
          ...
          >
            ...
            {file ? (
              <div className="flex items-center gap-3 w-full">
                ...
                <button onClick={(e) => { e.stopPropagation(); setFile(null); }} className="text-white/20 hover:text-white/60 p-1">X</button>
              </div>
            ) : (
              <div>
